...
### 🔍 What I Do
- Analyse structured & unstructured data to support business decisions
- Delivered clean, performance-optimised datasets for reporting and analytics
- Clean, transform, and prepare data using Power Query (ETL)  
- Build interactive dashboards using **Power BI, Tableau, and Advanced Excel**  
...
- **Visualisation:** Power BI, Tableau, Advanced Excel  
- **Databases:** MySQL  
